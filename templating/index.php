...
?>
        <div id="content">
            <h2>Bienvenue !</h2>
            <p id="intro">
                Bienvenue à la <strong>Pépinière Dominique!</strong> le site de la pépinière des soeurs Danielle, Odile et
                Magalie Dominique, productrices éco-responsables de végétaux de la vallée de l'elemant. Vous souhaitez
                acheter des produits éco-responsables de notre ferme ? Ou tout simplement mieux connaître la région.
            </p>
            <p id="avertissement">
                Attention! Nos produits sont éco-responsables. Nous n'avons pas de certification bio. Notre approche ...
            </p>
